...
class Net_Telnet
{
    ...
    function read_stream($searchfor = null, $numbytes = null, $timeout = null)
    {
        ...
        while (
            ...
            if ($this->mode['telnet'] && $c == TEL_IAC) {       /* Interpret As Command */
                ...
                if (
                    $this->mode['pager'] && (strlen($this->page_prompt) > 0)
    ...
    function login($args = null, $arg2 = null)
    {
        ...
        if (
            array_key_exists('login_prompt', $this->login)
        ...
        if (
            array_key_exists('password_prompt', $this->login)
        ...
        if (
            array_key_exists('login_fail', $this->login)
            && strlen($this->login['login_fail']) > 0
        ) {
